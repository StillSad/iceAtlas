...
//    public List<Activity> mActivityList;
    public Stack<Activity> mActivitieStack;
    ...
    public void onReceive(Message message) {
        switch (message.what) {
            ...
            case APP_EXIT:
                ...
                break;
            default:
                LogUtils.w(TAG,"The message.what not match");
                break;
        }
    }
    ...
    public void release() {
        ...
        mActivitieStack.clear();
        mActivitieStack = null;
//        mActivityList.clear();
//        mActivityList = null;
    ...
    public Stack<Activity> getActivityStack() {
        if (mActivitieStack == null) {
            mActivitieStack = new Stack<>();
        }
        return mActivitieStack;
    }
...
//    }
    ...
    public void addActivity(Activity activity) {
        ...
        synchronized (AppManager.class) {
            if (!mActivitieStack.contains(activity)) {
                mActivitieStack.add(activity);
            }
        }
    }
//    public void addActivity(Activity activity) {
...
//    }
    ...
    public void removeActivity(Activity activity) {
        ...
        synchronized (AppManager.class) {
            if (mActivitieStack.contains(activity)) {
                mActivitieStack.remove(activity);
            }
        }
    }
//    public void removeActivity(Activity activity) {
...
//    }
    ...
    public Activity removeActivity(int location) {
        ...
        synchronized (AppManager.class) {
            if (location > 0 && location < mActivitieStack.size()) {
                return mActivitieStack.remove(location);
            }
        }
        return null;
    }
...
//    }
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        ...
        return mActivitieStack.contains(activity);
    }
//    public boolean activityInstanceIsLive(Activity activity) {
//        if (mActivityList == null) {
//            LogUtils.w("mActivityList == null when activityInstanceIsLive");
