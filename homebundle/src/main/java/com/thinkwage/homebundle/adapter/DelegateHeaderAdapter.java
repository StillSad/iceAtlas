...
public class DelegateHeaderAdapter extends DelegateAdapter.Adapter {
    ...
    public DelegateHeaderAdapter(Context context, LayoutHelper helper) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FunctionModuleHolder(inflater.inflate(R.layout.item_home_bundle_header, parent, false));
    }
