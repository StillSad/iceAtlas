...
# in C:\Develop\Enviroment\Android\sdk/tools/proguard/proguard-android.txt
...
-keep public class * implements com.jess.arms.integration.ConfigModule
 ...
 #实体类不参与混淆
-keep class com.ice.library.widget.** { *; } #自定义控件不参与混淆
...
-keep class com.ice.library.aop.annotation.** { *; }
...
##############loginbundle##########
-dontwarn com.ice.loginbundle.**
-keep public class com.ice.loginbundle.**{*;}

##############userinfobundle##########
-dontwarn com.ice.userinfobundle.**
-keep public class com.ice.userinfobundle.**{*;}

##############visiontestbundle##########
-dontwarn com.ice.visiontestbundle.**
-keep public class com.ice.visiontestbundle.**{*;}